function Get-WhoIsActive 
{
    ...
    Process
    {
      ...
      $WIA = Invoke-Sqlcmd2 -ServerInstance $SqlCredobject.SqLServer -Database $SqlCredobject.Database  -Query $query -Credential $SqlCredobject.Cred -As PSObject
...
"@
        ...
        foreach($query in  $queries) {
            ...
            Invoke-Sqlcmd2 -ServerInstance $SqlCredobject.SqLServer -Database $SqlCredobject.Database  -Query $query -Credential $SqlCredobject.Cred 
